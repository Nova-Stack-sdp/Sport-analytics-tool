...
export default function TimeTravel({ onNavigate }) {
  return (
      ...
      <div className="content">
        ...
        <div className="grid grid-2">
          ...
          <div className="card">
            ...
            <button className="btn btn-ghost btn-full" style={{ marginTop: 14 }} onClick={() => onNavigate('datasets')}>View dataset releases</button>
          </div>
        </div>
      </div>
    </div>
