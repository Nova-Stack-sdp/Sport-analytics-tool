      ...
      <div className="content">
        ...
        <div className="grid grid-2">
          <div className="card">
            ...
            <button className="btn btn-ghost btn-full" style={{ marginTop: 14 }} onClick={() => onNavigate('fixtures')}>Open fixture</button>
          </div>
          ...
          <div className="card">
            ...
            <button className="btn btn-ghost btn-full" style={{ marginTop: 14 }} onClick={() => onNavigate('statistics')}>View full leaderboard</button>
          </div>
        </div>
        ...
        <div className="grid grid-2" style={{ marginTop: 16 }}>
          <div className="card">
            ...
            <button className="btn btn-ghost btn-full" style={{ marginTop: 14 }} onClick={() => onNavigate('statistics')}>View full comparison</button>
          </div>
          ...
          <div className="card">
            ...
            <button className="btn btn-ghost btn-full" style={{ marginTop: 14 }} onClick={() => onNavigate('submissions')}>Open submissions</button>
          </div>
        </div>
      </div>
    </div>
